...
require_once(dirname(__FILE__) . '/model/tm_search.php');
                    ...
                    <div class="row row-left-30 div-product-tab">
                        <div class="tab-content">
                            <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
                                ...
                                <!-- tab - For rent -->
<!--                                <li><a href="#for-rent" data-toggle="tab">For rent</a></li>
                                 tab - For sale 
                                <li><a href="#for-sale" data-toggle="tab">For sale</a></li>-->
                            </ul>
                            <div id="my-tab-content" class="tab-content">
                                ...
                                <div class="tab-pane active" id="hot-property">
                                    ...
                                    <ul class="pagination product-pagin center">
                                        <li><a href="search.php?optradio=<?php
                                                if (isset($optradio)) {
                                                    echo "$optradio";
                                                }
                                                ?>&loca=<?php
                                        ...
                                        <?php } ?>
                                            <li><a  href="search.php?optradio=<?php
                                                ...
                                                ?>&loca=<?php
                                                            ...
                                                            ?>&page=<?php if($page<$totalpage-1){echo $page+1;} ?>">>></a></li>
                                    </ul>
                                    <!-- End - pagination -->
                                </div>
...
<!--                                <div class="tab-pane" id="for-sale">
                ...
                <div class="col-md-3 col-sm-12 content-col">
                    ...
                    <form class="row form-compare">
                        ...
                        <button type="button" onclick="co_sel()" class="btn cs-btn cs-btn-compare col-lg-12 col-md-12 col-xs-12 cold-sm-12"  title="Compare">Compare</button>

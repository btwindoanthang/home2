...
<html>
    <head>
        ...
        <script src="htdocs/js/hotnews.js"></script>
        <script src="htdocs/js/script.js"></script>
        <script src="pgw/jquery.bxslider.js"></script>
        <link rel="stylesheet" href="pgw/jquery.bxslider.css"/>
            ...
            <div class="container content-main">
                ...
                <div class="col-md-9 col-sm-12 content-col">
                    ...
                    <div class="row row-left-15 div-product-slide">
                        <!-- product-slide -->
                        <div class="col-md-8 list-product-slide">
                            <div class="row">
                                <div class="content-top">
                                    <div class="hotnewsframeimage">
                                        <div class="hotnewsframeimage1">
                                            <img src="img/product/<?php echo $product[0]['image'] ?>" alt="">
                                        </div>
                                    </div>
                                    <div class="hotnewsright" style="overflow: hidden;"><p  ><?php echo $product[0]['name']; ?></p></div>

                                </div>
                                <div class="content-middle">
                                    <a class="prev-slide" href="javascript:movescrollprev()" title="prev slide"><img src="htdocs/image/web/icon-left.ico" alt=""></a>
                                    <a class="next-slide" href="javascript:movescrollnext()" title="next slide"><img src="htdocs/image/web/icon-right.ico" alt=""></a>
                                </div>

                                <div class="content-bottom">
                                    <div class="hotnewsscroll">
                                        <?php foreach ($product as $p1) { ?>
                                            <a class="hotnewsscrolle" onclick="de_sel('<?php echo $p1["id"] ?>', '<?php echo$p1["image"] ?>')" datetime="<?php echo $p1[5] ?>" des="<?php echo $p1['name']; ?>" image="img/product/<?php echo $p1[6] ?>" title=""><img style="float: left;width: 17.8% !important;max-width:100px;border-radius: 5px;  height: 60px !important" src="img/product/<?php echo $p1[6] ?>" alt=""></a>
                        ...
                        <!-- product-new -->
                        <div class="col-md-4 list-product-new  visible-md visible-lg ">
                            <h4 class="title-list"><?php echo constant("NEW_PROPERTY"); ?></h4>
                            <div class="list-item" id="id-list-new-product">
                                <?php foreach ($product_new as $p1) { ?>	
                                    <div class="item">
                                        <a onclick="de_sel('<?php echo $p1["id"] ?>', '<?php echo$p1["image"] ?>')" title="">
                                            <img src="img/product/<?php echo $p1[6] ?>" alt="">
                                            <p style="overflow: hidden;height: 40px;"><?php echo $p1[3] ?></p>
                                        </a>
                                    </div>
                    ...
                    <div class="row row-left-30 div-product-tab">
                        <div class="tab-content">
                            <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
                                <!-- tab - Hot property -->
                                <li class="active"><a href="#hot-property" data-toggle="tab"><?php echo constant("HOT_PROPRETY"); ?></a></li>
                                <!-- tab - For rent -->
                            ...
                            <div id="my-tab-content" class="tab-content">
                                ...
                                <div class="tab-pane" id="for-rent">
                                    <!-- product -->
                                    <?php foreach ($rent as $p1) { ?>
                                        <div class="product">
                                            <div class="col-md-4 col-sm-12">
                                                <a style="z-index: 1000" onclick="de_sel('<?php echo $p1["id"] ?>', '<?php echo$p1["image"] ?>')" class="product-image">
                                                    <img src="img/product/<?php echo $p1[6] ?>" alt=""/>
                                                </a>
                                            </div>
                                            <div class="col-md-8 col-sm-12">
                                                <a style="z-index: 1000" onclick="de_sel('<?php echo $p1["id"] ?>', '<?php echo$p1["image"] ?>')" class="product-title" title=""><?php echo $p1[3] ?></a>
                ...
                <div class="container" id="detail">
                    <!--                    <div class="modal-dialog row content-dialog detail-house">
                                            ...
                                            <div class="row div-product">
                                                 title product 
                                                <h4 class="col-md-12 product-name">Appartmemt number 1</h4>
                    
                                                 product-slide 
                                                <div class="col-md-7 list-product-image">
                                                    <div class="img-main"><a href="" title=""><img src="image/slides/4.jpg" alt=""></a></div>
                                                    <div class="img-childs">
                                                        <a href="" title=""><img src="image/slides/4.jpg" alt=""></a>
                                                        <a href="" title=""><img src="image/slides/2.jpg" alt=""></a>
                                                        <a href="" title=""><img src="image/slides/3.jpg" alt=""></a>
                                                        <a href="" title=""><img src="image/slides/4.jpg" alt=""></a>
                                                        <a href="" title=""><img src="image/slides/2.jpg" alt=""></a>
                                                        <a href="" title=""><img src="image/slides/2.jpg" alt=""></a>
                                                        <a href="" title=""><img src="image/slides/3.jpg" alt=""></a>
                                                ...
                                                <div class="col-md-5 list-product-info">
                                                    ...
                                                    <h6 class="location visible-md visible-lg"><b>Location:</b> District 1, HCM city</h6>
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="info">$12,000/month</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="title">- Topical:</td>
                                                                    <td class="info">Appartment</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                ...
                                                <div class="col-md-12 description">
                                                    ...
                                                    <div class="des-detail">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                        ...
                                        <script>
                                                                        function load_map() {
                                                                            ...
                                                                            var map = new google.maps.Map(document.getElementById("id-product-map-pc"), mapProp);
                                                                            var map2 = new google.maps.Map(document.getElementById("id-product-map-mobi"), mapProp);
                                                                        }

<?php
session_start();
require_once(dirname(__FILE__) . '/model/forum_detail.php');
?>
<!DOCTYPE html>
<html>
    <head>
...
<!--                    <span>&raquo;</span>
                    ...
                    <span>&raquo;</span>
                    <span><a href="#" title=""><?php echo $forum[0]['title'] ?></a></span>
                </div><!-- END: link category -->

                <!-- content -->
                <div class="content">
                    <div class="row">
                        <div class="col-lg-8 content-news">
                            <div class="content-genneral">
                                <h3 class="title-content"><?php echo $forum[0]['title'] ?></h3>
                                <div class="detail-house">
                                    <div class="slide-image-house">
                                        <div class="row">
                                            <div class="hotnewsframeimage col-lg-11">
                                                <div class="hotnewsframeimage2  house-image-main">
                                                    <img src="img/product/<?php echo $forum[0]['image'] ?>" alt="">
                                                </div>
...
<!--                                           <div class="col-lg-3 house-image-list">
                				<a href="" title=""><img src="htdocs/image/slides/3.jpg" alt=""></a>
                				<a href="" title=""><img src="htdocs/image/slides/3.jpg" alt=""></a>
                				<a href="" title=""><img src="htdocs/image/slides/3.jpg" alt=""></a>
                				<a href="" title=""><img src="htdocs/image/slides/3.jpg" alt=""></a>
                			</div>-->
                                            <div class=" content-bottom col-lg-8 ">
                                                <div class="hotnewsscroll2">
                                                    <?php foreach ($imageforum as $im){ ?>
                                                    <a class="hotnewsscrolle2  " image="img/product/<?php echo $im['name'] ?>"  href="" title=""><img src="img/product/<?php echo $im['name'] ?>" alt=""></a>
                                                    <?php }?>
                                                </div>
<!--                                                <div class="l"   onclick="movescrollprev()"></div>
                                                <div class="r" onclick="movescrollnext()" ></div>-->
                                            </div>
                                        </div>
                                    </div>
                                    <div class="information-house">
                                        <div class="row">
                                            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 inform-detail type">
                                                <a class="type-rent" href="" title="">Rent</a>
                                                <a class="type-sale" href="" title="">Sale</a>
                                            </div>

                                            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 inform-detail author">
                                                <span>Author:</span>
                                                <a href="" title=""><?php echo $forum[0]['name'] ?></a>
                                            </div>

                                            <div class=" col-lg-4 inform-detail date-post">
                                                <span>Date post:</span>
                                                <a href="" title=""><?php echo $forum[0]['datepost'] ?></a>
                                            </div>

<!--                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 inform-detail inform-detail-money">
                                                <span class="title">Price: </span>
                                                <span class="inform money"><?php echo $forum[0]['price'] ?> USD </span>
                                            </div>

                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 inform-detail">
                                                <span class="title">Square: </span>
                                                <span class="inform">17 m2 </span>
                                            </div>

                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 inform-detail">
                                                <span class="title">Number room: </span>
                                                <span class="inform">2</span>
                                            </div>

                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 inform-detail">
                                                <span class="title">Address: </span>
                                                <span class="inform">12 Le Thanh Ton street, District 1, HCM city</span>
                                            </div>-->

                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 inform-detail inform-detail-more">
                                                <span class="title">Description:<br/> </span>
                                                <span class="inform"><?php echo $forum[0]['description'] ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 content-panel">
                            ...
                            <!-- group support  -->
                            <h4 class="content-panel-title">Contact</h4>
                            <div class="content-genneral support">
                                <h4><img src="htdocs/image/web/icon-phone-2.ico" class="icon-contact" alt=""> <?php echo $forum[0]['name'] ?> : <?php echo $forum[0]['phone'] ?></h4>
                                <h4><img src="htdocs/image/web/icon-email.ico" class="icon-contact" alt=""><?php echo $forum[0]['email'] ?></h4>
